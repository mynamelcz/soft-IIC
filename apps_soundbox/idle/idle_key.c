...
const u16 idle_ad_table[4][KEY_REG_AD_MAX] = {
    /*短按*/	    {ADKEY_IDLE_SHORT},
    /*长按*/		{ADKEY_IDLE_LONG},
    /*连按*/		{ADKEY_IDLE_HOLD},
...
const u16 idle_io_table[4][KEY_REG_IO_MAX] = {
    /*短按*/	    {IOKEY_IDLE_SHORT},
    /*长按*/		{IOKEY_IDLE_LONG},
    /*连按*/		{IOKEY_IDLE_HOLD},
...
#define IRFF00_IDLE_KEY_LONG_UP 		\
								...
								/*19*/    NO_MSG,\
								/*20*/    NO_MSG
const u16 idle_ir_table[4][KEY_REG_IR_MAX] = {
...
const u16 idle_touch_table[4][KEY_REG_TOUCH_MAX] = {
    /*短按*/	    {TOUCHKEY_IDLE_SHORT},
    /*长按*/		{TOUCHKEY_IDLE_LONG},
    /*连按*/		{TOUCHKEY_IDLE_HOLD},
    /*长按抬起*/	{TOUCHKEY_IDLE_LONG_UP},
};
const KEY_REG idle_mode_key = {
    ._ad = idle_ad_table,
    ._io = idle_io_table,
    ._ir = idle_ir_table,
    ._touch = idle_touch_table,
};
