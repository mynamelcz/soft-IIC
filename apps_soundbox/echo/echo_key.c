...
const u16 echo_ad_table[4][KEY_REG_AD_MAX] = {
    /*短按*/	    {ADKEY_ECHO_SHORT},
    /*长按*/		{ADKEY_ECHO_LONG},
    /*连按*/		{ADKEY_ECHO_HOLD},
...
const u16 echo_io_table[4][KEY_REG_IO_MAX] = {
    /*短按*/	    {IOKEY_ECHO_SHORT},
    /*长按*/		{IOKEY_ECHO_LONG},
    /*连按*/		{IOKEY_ECHO_HOLD},
...
#define IRFF00_ECHO_KEY_LONG_UP 		\
								...
								/*19*/    NO_MSG,\
								/*20*/    NO_MSG
const u16 echo_ir_table[4][KEY_REG_IR_MAX] = {
...
const u16 echo_touch_table[4][KEY_REG_TOUCH_MAX] = {
    /*短按*/	    {TOUCHKEY_ECHO_SHORT},
    /*长按*/		{TOUCHKEY_ECHO_LONG},
    /*连按*/		{TOUCHKEY_ECHO_HOLD},
    /*长按抬起*/	{TOUCHKEY_ECHO_LONG_UP},
};
const KEY_REG echo_mode_key = {
    ._ad = echo_ad_table,
    ._io = echo_io_table,
    ._ir = echo_ir_table,
    ._touch = echo_touch_table,
};
#endif
