...
const u16 adkey_msg_rec_table[4][KEY_REG_AD_MAX] = {
    /*短按*/	    {ADKEY_ENC_SHORT},
    /*长按*/		{ADKEY_ENC_LONG},
    /*连按*/		{ADKEY_ENC_HOLD},
...
const u16 iokey_msg_rec_table[4][KEY_REG_IO_MAX] = {
    /*短按*/	    {IOKEY_ENC_SHORT},
    /*长按*/		{IOKEY_ENC_LONG},
    /*连按*/		{IOKEY_ENC_HOLD},
...
#define IRFF00_ENC_KEY_LONG_UP 		\
								...
								/*19*/    NO_MSG,\
								/*20*/    NO_MSG
const u16 irff00_msg_rec_table[4][KEY_REG_IR_MAX] = {
...
const u16 touchkey_msg_rec_table[4][KEY_REG_TOUCH_MAX] = {
    /*短按*/	    {TOUCHKEY_ENC_SHORT},
    /*长按*/		{TOUCHKEY_ENC_LONG},
    /*连按*/		{TOUCHKEY_ENC_HOLD},
    /*长按抬起*/	{TOUCHKEY_ENC_LONG_UP},
};
const KEY_REG rec_mode_key = {
    ._ad = adkey_msg_rec_table,
    ._io = iokey_msg_rec_table,
    ._ir = irff00_msg_rec_table,
    ._touch = touchkey_msg_rec_table,
};
