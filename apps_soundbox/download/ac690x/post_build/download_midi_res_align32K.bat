...
isd_download.exe -tonorflash -dev br17 -boot 0x2000 -div6 -wait 300 -f toyuboot.boot sdram.app bt_cfg.bin fast_run.bin midi_cfg.bin jlhtk.bin voice.res midi.res -faline midi.res,0x1000,0x8000,1
