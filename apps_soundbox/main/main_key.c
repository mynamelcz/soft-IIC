...
const u16 main_ad_table[4][KEY_REG_AD_MAX] = {
    /*短按*/	    {ADKEY_MAIN_SHORT},
    /*长按*/		{ADKEY_MAIN_LONG},
    /*连按*/		{ADKEY_MAIN_HOLD},
...
const u16 main_io_table[4][KEY_REG_IO_MAX] = {
    /*短按*/	    {IOKEY_MAIN_SHORT},
    /*长按*/		{IOKEY_MAIN_LONG},
    /*连按*/		{IOKEY_MAIN_HOLD},
...
#define IRFF00_MAIN_KEY_LONG_UP 		\
								...
								/*19*/    NO_MSG,\
								/*20*/    NO_MSG
const u16 main_ir_table[4][KEY_REG_IR_MAX] = {
...
const u16 main_touch_table[4][KEY_REG_TOUCH_MAX] = {
    /*短按*/	    {TOUCHKEY_MAIN_SHORT},
    /*长按*/		{TOUCHKEY_MAIN_LONG},
    /*连按*/		{TOUCHKEY_MAIN_HOLD},
    /*长按抬起*/	{TOUCHKEY_MAIN_LONG_UP},
};
const KEY_REG main_mode_key = {
    ._ad = main_ad_table,
    ._io = main_io_table,
    ._ir = main_ir_table,
    ._touch = main_touch_table,
};
