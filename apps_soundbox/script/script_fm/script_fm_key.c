...
const u16 script_fm_ad_table[4][KEY_REG_AD_MAX] = {
    /*短按*/	    {ADKEY_FM_SHORT},
    /*长按*/		{ADKEY_FM_LONG},
    /*连按*/		{ADKEY_FM_HOLD},
...
const u16 script_fm_io_table[4][KEY_REG_IO_MAX] = {
    /*短按*/	    {IOKEY_FM_SHORT},
    /*长按*/		{IOKEY_FM_LONG},
    /*连按*/		{IOKEY_FM_HOLD},
...
#define IRFF00_FM_KEY_LONG_UP 		\
								...
								/*19*/    NO_MSG,\
								/*20*/    NO_MSG
const u16 script_fm_ir_table[4][KEY_REG_IR_MAX] = {
...
const u16 script_fm_touch_table[4][KEY_REG_TOUCH_MAX] = {
...
const KEY_REG script_fm_key = {
    ._ad = script_fm_ad_table,
    ._io = script_fm_io_table,
    ._ir = script_fm_ir_table,
    ._touch = script_fm_touch_table,
};
