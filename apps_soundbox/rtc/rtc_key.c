...
const u16 rtc_ad_table[4][KEY_REG_AD_MAX] = {
    /*短按*/	    {ADKEY_RTC_SHORT},
    /*长按*/		{ADKEY_RTC_LONG},
    /*连按*/		{ADKEY_RTC_HOLD},
...
const u16 rtc_io_table[4][KEY_REG_IO_MAX] = {
    /*短按*/	    {IOKEY_RTC_SHORT},
    /*长按*/		{IOKEY_RTC_LONG},
    /*连按*/		{IOKEY_RTC_HOLD},
...
#define IRFF00_RTC_KEY_LONG_UP 		\
								...
								/*19*/    NO_MSG,\
								/*20*/    NO_MSG
const u16 rtc_ir_table[4][KEY_REG_IR_MAX] = {
...
const u16 rtc_touch_table[4][KEY_REG_TOUCH_MAX] = {
...
const KEY_REG rtc_mode_key = {
    ._ad = rtc_ad_table,
    ._io = rtc_io_table,
    ._ir = rtc_ir_table,
    ._touch = rtc_touch_table,
};
