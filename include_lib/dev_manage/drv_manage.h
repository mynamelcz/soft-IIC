...
extern DEV_HANDLE volatile spi1;        ///>设备句柄
extern DEV_HANDLE volatile spifat0;        ///>设备句柄
extern DEV_HANDLE volatile spifat1;        ///>设备句柄
...
void *dev_get_priv_param(DEV_HANDLE hdev);
