...
/*
 * hFile    (_FIL_HDL *)
            ((MUSIC_OP_API *)m_op_api)->fop_api->cur_lgdev_info->lg_hdl->file_hdl
 */
typedef struct {
    u32(*m_FunRead)(void *hFile, void *buf, u32 size);
    u32(*m_FunWrite)(void *hFile, void *buf, u32 size);
    s32(*m_FunSeek)(void *hFile, u16 order, u32 offset);
    u32(*m_FunTell)(void *hFile);
    u32(*m_Funlength)(void *hFile);
} mulfile_func_t;
...
typedef struct __DEC_CTRL_CB {
    void *priv;
    void (*_cb)(void *priv);
} DEC_CTRL_CB;

typedef struct __DEC_OP_CB {
    void  *priv;
    void (*clr)(void *priv);
    tbool(*over)(void *priv);
} DEC_OP_CB;
