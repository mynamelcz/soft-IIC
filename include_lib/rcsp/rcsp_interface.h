...
typedef enum {
    ...
    //MUSIC private msg
    RCSP_CBK_MSG_MUSIC_SPC_FILE = 0x30,//此RCSP_CBK_MSG_MUSIC_SPC_FILE消息不能修改顺序， 在库里调用
    RCSP_CBK_MSG_MUSIC_PREV_DEV,
...
extern void rcsp_pc_task_sync_vol_init(void);
...
extern void rcsp_music_init(MUSIC_OP_API *mapi);
extern void rscp_music_exit(void);
extern const char *get_rcsp_curr_script_name(void);
extern u32 get_rcsp_curr_script_id(const char *rcsp_script_name);
